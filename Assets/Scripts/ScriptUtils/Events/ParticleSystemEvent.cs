...
{
    /// <summary>
    /// Used to determine when a particle system is done playing.
    /// Requires a ParticleSystem component be attached to the same gameObject.
    /// </summary>
    ...
    public class ParticleSystemEvent : MonoBehaviour
    {
        ...
        public delegate void ParticlySystemDoneDelegate(ParticleSystemEvent target);
        /// <summary>
